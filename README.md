...
The repository also contains a config file for i3status for a more user friendly status bar. Copy the i3status directory to the .config directory to implement it.
